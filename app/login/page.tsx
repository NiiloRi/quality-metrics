      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="card-professional p-8 text-center">
            ...
            {/* Title */}
            <h1 className="text-2xl font-bold text-[var(--foreground)] font-heading mb-2">
              {t('login.title')}
            </h1>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-gray-800 font-medium rounded-xl hover:bg-gray-100 transition-colors shadow-lg"
            >
              {/* Google Icon */}
            ...
            <div className="mt-8 p-4 bg-[var(--background-secondary)] rounded-xl">
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <span className="font-semibold text-[var(--foreground)]">14-day free trial</span>
              </div>
